...
class Const {
    ...
    AREA_CODE = [
        ...
        },
        {
            ...
            phoneCode: '90',
            zhHead: 'T',
            continent: 'Europe', // Note: Turkey is transcontinental, spanning both Europe and Asia.
        },
        {
            en: 'Turkmenistan',
            zh: '土库曼斯坦',
        ...
        },
        {
            ...
            phoneCode: '381',
            zhHead: 'N',
            continent: 'Europe', // Note: Yugoslavia has dissolved; this entry might refer to one of its successor states.
        },
        {
            en: 'Zimbabwe',
            zh: '津巴布韦',
        ...
        },
        {
            ...
            phoneCode: '243',
            zhHead: 'Z',
            continent: 'Africa', // Note: Zaire is now known as the Democratic Republic of the Congo.
        },
        {
            en: 'Zambia',
            zh: '赞比亚',
